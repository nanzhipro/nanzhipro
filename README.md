...
我是南师傅。20 年 macOS 系统编程经验，一直在一线写代码。
...
| Project | What it is |
| --- | --- |
| ⭐ [AppScope](https://github.com/nanzhipro/AppScope) | **代表作** — macOS Quick Look 安全审查扩展：空格键查看任意 App 的 7 维风险评分、签名、权限、网络、文件系统。Apple 原生实现，零依赖 |
